...
echo  "VERSION   : V.5 " | lolcat
echo  "TOTALS    : 4 TOOLS " | lolcat
...
echo ""
echo "============================" | lolcat
echo "1. Install Tools B4J1N64N2${enda}";
echo "============================" | lolcat
echo "2. Install Tools B4J1N64Nv4​${enda}";
echo "============================" | lolcat
echo "3. Install Tools B4J1N64Nv5​${enda}";
echo "============================" | lolcat
echo "4. Install Tools B4J1N64Nv6${enda}";
echo "============================" | lolcat
echo "00. Exit"
echo "============================" | lolcat
